...
public class ImagePaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{
	...
	public void initVariables(){
        ...
        */
		...
		firstPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"first\">처음</a>";
		previousPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"prev\">이전</a>";
		currentPageLabel = "<a href=\"javascript:;\" class=\"active\">{0}</a></li>";
		otherPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">{2}</a>";
		nextPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"next\">다음</a>";
		lastPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"last\">마지막</a>";
