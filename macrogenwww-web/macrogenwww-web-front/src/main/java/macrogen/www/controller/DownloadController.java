...
public class DownloadController {
	...
	@RequestMapping("/filename/{filename:.+}")
	public void filename(@PathVariable String filename,
		HttpServletRequest request, HttpServletResponse response) throws Exception{

		// 물리경로 가져오기
		String filePath = request.getSession().getServletContext().getRealPath("/downfile");

		storageService.downloadFile(filePath + "/" + filename, filename, request, response);
	}
