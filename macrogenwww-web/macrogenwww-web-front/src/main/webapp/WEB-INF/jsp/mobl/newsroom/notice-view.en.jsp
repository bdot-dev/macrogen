                ...
                <div class="board">
                        <div class="view">
                            ...
                            <div class="view-body">
                            	<%--
                                <div class="img">
                                	<img src="/publishing/mobile-en/dist/img/@temp/newsroom/sample-1.png" alt="제목 텍스트 제목 텍스트 제목 텍스트 제목 텍스트">
                                </div>
                            	 --%>
                                <div class="font-body">
		                            ${resultVo.nttCn }
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
	                                    	<c:if test="${ not empty prevVo }">
	                                        	<i class="icon ico-left-black btn-prev"></i><span class="font-body-h-b">Previous</span>
	                                    	</c:if>
                                        </div>
                                        <div class="col">
	                                    	<c:if test="${ not empty prevVo }">
