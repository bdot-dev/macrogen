        ...
        <div class="section_business">
            ...
            <div class="info-box-wrap tab-content">
                ...
                <div class="info-box show">
                    ...
                    <p class="subject font-body-h-b">Standard sequencing is a service that sequences PCR products and plasmid DNA requested by customers.</p>
                    <p class="desc img_bottom font-body">Macrogen provides quicker and more accurate services based on its Capillary Electrophoresis Sequencing (CES) automation system and extensive experience.<br>
                    ...
                    <div class="list-area-group">
                        <div class="list-area">
                            ...
                            <ul class="list-circle-dot">
                                ...
                                <li><p>Real-time monitoring available from order receipt to delivery of the results based on Laboratory Information Management System (LIMS)</p></li>
                                <li><p>Results provided within 24 hours after the submission of the sample (to be submitted before 6:00pm)</p></li>
                                <li><p>Free basic analysis service (homology search using BlastN and DNA sequence orders)</p></li>
                    ...
                    <p class="desc font-body list_bottom">Standard sequencing can be performed with single tubes and 96-well plates.</p>
                    <div class="list-area-group">
                        <div class="list-area">
                    ...
                    <p class="desc font-body list_bottom">Difficult template sequencing is a service for sequencing templates that have an unusual structure based on the customer’s information after confirming
                    ...
                    <div class="border-gray-box">
                        <div class="img">
                            <img src="/publishing/mobile-en/dist/img/business/img_sequencingchart.png" alt="Difficult Template Sequencing">
                ...
                <div class="info-box">
                    ...
                    <p class="subject font-body-h-b">This is a package service that provides universally used microorganism/biological species identification test from prep to analysis.</p>
                    <!--10.05 이미지 경로 변경-->
                    <div class="img">
                    ...
                    <p class="desc list_bottom font-body">This service identifies bacteria by performing PCR using 16S rRNA gene 27F and 1492R primer and sequencing them with inter-primers, 785F and 907R. We provide a base sequence of about 1,350bp or more by selecting/changing the primer if requested by the client.</p>
                    <div class="list-area-group">
                        <div class="list-area">
                            <p class="font-body-h-b title">Bacteria+</p>
                            <p class="desc font-body">For bacteria, PCR of 16S rRNA genes is performed using 27F and 1492R primers, and it is sequenced using 785F and 907R primers, which are the inter-primers, for identification.<br>
                    ...
                    <div class="list-area">
                        ...
                        <ul class="list-circle-dot">
                            ...
                            <li><p>First FDA Clearance for microbiological identification accuracy and AOAC Validation (US)</p></li>
                        </ul>
                    </div>
                    <div class="btn-area">
                        <div class="btn-wrapper"><a href="mailto:sequencing@macrogen.com" class="btn btn-light"><span>Service Inquiry</span></a>
                ...
                <div class="info-box">
                    ...
                    <p class="desc list_bottom font-body">Fragment analysis is a service that separates and analyzes amplified PCR products according to fragments using a primer marked by a fluorescent label.
                        It is used for genotyping, DNA profiling, medical mutation detection, and agricultural research. We also provide test design service from PCR optimization to analysis upon request.
                    </p>
                    <div class="list-area-group">
                        <div class="list-area">
                            ...
                            <ul class="list-circle-dot">
                                ...
                                <li><p>Relative fluorescent quantization - Loss of heterozygosity (LOH), Aneuploidy assays, and Large chromosomal deletion detection</p></li>
                        ...
                        <div class="list-area">
                            <p class="font-body-h-b title">Features</p>
                            <ul class="list-circle-dot">
                                <li><p>The result data is provided in FSA file format (PDF/Excel also available)</p></li>
                                <li><p>The results are delivered within 3 to 7 business days after the collection of the samples.</p></li>
                                <li><p>Customized service from PCR optimization to fragment analysis is available</p></li>
                            </ul>
                        </div>
                    </div>
                    <div class="btn-area">
                ...
                <div class="info-box">
                    ...
                    <p class="subject font-body-h-b">Customized Sequencing provides sanger sequencing tests, prep, PCR, cloning, and pyrosequencing under the same conditions.</p>
                    <div class="img">
                    ...
                    <p class="desc list_bottom font-body">PCR optimization is a customized service that performs and analyzes the entire process from primer design to PCR amplification, sequencing, and BI report when the customer provides references together with cell/gDNA in relation to the desired target region. If the retest rate is high due to the rarity of the sample in PCR amplification, touchdown PCR amplification, nested PCR amplification and FFPE PCR amplification, then Macrogen solves the problem by using its customized PCR amplification service.</p>
                    <div class="list-area">
                        <p class="title font-body-h-b">Features</p>
                        <ul class="list-circle-dot">
                    ...
                    <p class="desc list_bottom font-body">Pyrosequencing is a sequencing service using pyrophosphate (PPi) generated when the polymerization of nucleotide with DNA occurs.
                    ...
                    <div class="list-area">
                        <p class="font-body-h-b title">Features</p>
                        <ul class="list-circle-dot">
                            <li><p>Quicker and more accurate tests for clients using Macrogen’s NGS service, thanks to direct transfer of the samples.</p></li>
                            <li><p>When the chromosome position and reference sequence are verified, one-stop service is available from overall primer design to verification of sequencing results and comparative analysis of variants.</p></li>
                            <li><p>Normal control data can be checked for comparison for more accurate results if necessary.</p></li>
                            <li><p>Data can be checked using two primer sets for the same site.</p></li>
                        </ul>
                    </div>
                    <hr class="divider">
                    <p class="font-h5 sub-title" id="ancher4">MLST analysis</p>
                    <p class="desc font-body img_bottom">MLST (Multilocus Sequence Typing) is a technique used to classify strains with the same species such as bacteria and fungi. Sequencing is performed on five to seven specific housekeeping genes of species to analyze the correlation of each ST (Sequence Type). Genetic/molecular evolutionary relations can then be verified by the combination of alleles for each strain in the same species.</p>
                    <div class="border-gray-box">
                        <div class="img">
                    ...
                    <p class="desc font-body" id="ancher5">
                ...
                <div class="info-box">
                    ...
                    <div class="list-gallery">
                        <div class="list">
                            <p class="title font-h5" id="ancher6">Parentage Test</p>
                            <div class="content">
                                <div class="img mb-0">
                        ...
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="ancher7">Paternity Test</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                                    <img src="/publishing/mobile-en/dist/img/business/img-ces-test2.png" alt="부계확인검사">
                                </div>
                                <p class="desc font-body">For sex chromosomes, males have XY and females have XX. The Y chromosome exists only in males, and the Y chromosome received from the father is passed on only to the son. Therefore, when compared to the parent's DNA, the half matches the father and the other halfm atches the mother. The paternity test examines 15 STR genetic loci present on the Y chromosome, and when the probability is 99.9% or more, the person can be considered as the child. </p>
                            </div>

                        </div>
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="ancher8">Maternity Test</p>
                            <div class="content">
                                <div class="img mb-0">
                                    <img src="/publishing/mobile-en/dist/img/business/img-ces-test3.png" alt="모계확인검사">
                                </div>
                                <p class="desc font-body">Human cells contain a small amount of mitochondrial DNA outside the nucleus along with the DNA present in the nucleus. During cell fertilization, the sperm transfers only the DNA in the nucleus to the egg. As a result, mitochondrial DNA cannot enter the fertilized egg. Consequently, mitochondrial DNA is inherited from the mother. The mother's mitochondrial DNA is passed on to her son and her daughter, who in turn passes on her own mitochondrial DNA to her offspring and thus, this is used to study the human origin of the child.</div>
                        </div>
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="ancher9">Personal Identity Test</p>
                            <div class="content">
                                <div class="img mb-0">
                                    <img src="/publishing/mobile-en/dist/img/business/img-ces-test4.png" alt="개인식별검사">
                                </div>
                                <p class="desc font-body">Personal identification testing or DNA profiling is used as a genetic testing method in criminal investigations. Human ID analyzes 16 STR loci based on the international standardized analysis technique (CODIS locus used by the FBI) and conducts personal identity tests. STR (Short Tandem Repeat) refers to a section in which 2 to 7 bases are continuously repeated in a human DNA sequence. This analytical technique is similar to inheriting a blood type from their parent.
    ...
    <div class="modal modal-image-viewer" tabindex="-1" id="modalImageViewer1" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="parent">
                    <div class="panzoom"><img src="/publishing/mobile-en/dist/img/business/img_sequencingchart.png" alt="Difficult Template Sequencing"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal modal-image-viewer" tabindex="-1" id="modalImageViewer2" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <a href="#" class="btn-close"><span class="sr-only">Close</span></a>
                <div class="parent">
                    <div class="panzoom"><img src="/publishing/mobile-en/dist/img/business/img_mslt.png" alt="Difficult Template Sequencing"></div>
                </div>
            </div>
        </div>
    </div>
