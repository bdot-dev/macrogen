        ...
        <div class="section_business">
            ...
            <div class="info-box-wrap tab-content">
                ...
                <div class="info-box show">
                    ...
                    <p class="desc list_bottom font-body">mRNA(messenger RNA)는 DNA가 전사될 때 생성되는 RNA의 일종입니다. mRNA는 단백질 정보를 담고 있는 coding region을 포함합니다. 특정 환경에서 주요 기능을 수행하는 유전자와
                        ...
                        <div class="list-area">
                            ...
                            <div class="table-scroll">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="text-start">Identifying differentially expressed genes(T-test, LPE
                                            test, ANOVA etc.)
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="text-start">Clustering Analysis for DEG ( Hierarchical clustering,
                                            K-means etc.)
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <p class="desc font-body list_bottom">번역(Translation) 과정에서 유전자의 발현을 조절하는 다양한 microRNA에 대한 정보를 빠르게 스크리닝하여 한번에 얻을 수 있는 분석방법입니다.
                    ...
                    <div class="btn-area">
                        <div class="btn-wrapper"><a href="mailto:array@macrogen.com" class="btn btn-light"><span>서비스문의</span></a>
                        ...
                        <div class="btn-wrapper"><a href="mailto:array@macrogen.com" target="_blank" class="btn btn-primary"><i
                ...
                <div class="info-box">
                    ...
                    <p class="desc list_bottom font-body">약 30억 쌍의 염기로 구성된 인간 유전체의 경우 개인의 DNA 염기서열이 대부분 일치하지만  0.1% 정도 차이가 나는 단일염기다형성(SNP, Single Nucleotide Polymorphism) 부위를 가지고 있습니다.
                ...
                <div class="info-box">
                    ...
                    <p class="desc font-body list_bottom">DNA 메틸화(DNA methylation)란 유전자의 발현을 조절하는 화학적 변형으로서 유전자의 전사조절영역을 중심으로 존재하는 CpG site의 시토신(Cytosine)에 메틸기가 생성되는 현상입니다.
