            ...
            <div class="select-nav-box _content-anchor">
                ...
                <div class="select-box">
                    ...
                    <ul class="select-option _select-option">
                        <li class="option-value"><a href="#">질병예측 & 웰니스 유전자검사</a></li>
            ...
            <div class="info-box-wrap">
                ...
                <div class="info-box show">
                    ...
                    <div class="list-gallery">
                        <div class="list">
                            <p class="title font-h5" id="target1">마이지놈스토리 블루 (질병 예측)</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                        ...
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="target2">마이지놈스토리 그린 (웰니스)</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                        ...
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="target3">마이지놈스토리 골드 (종합형)</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                        ...
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="target4">젠톡 (질병 예측)</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                                ...
                                <div class="cont">
                                    <p class="desc font-body">건강설문과 병원 EMR 데이터를 결합한 최초의 유전자 검사 서비스로 ‘젠톡’ 모바일 앱을 통해  검사 결과를 확인하고 주기적으로 건강 정보를 받아볼 수 있습니다.  특히 Master 검사의 경우, 질병 발생 가능성과 관련 있는 강력한 유전변이인 병원성 변이를 함께 분석하여, 높은 예측도의 검사 결과를 제공합니다.</p>
                                    <div class="list-area">
                                        <ul class="list-circle-dot">
                ...
                <div class="info-box">
                    ...
                    <p class="subject font-body-h">‘마이지놈스토리 더플러스’는 의료기관을 방문하지 않고, 소비자가 직접 개인의 특성이나 건강과 관련된 웰니스 항목을 검사할 수 있는 DTC(Direct-To-Customer) 유전자검사 서비스입니다. 검사 항목은 영양소, 운동, 피부·모발, 식습관, 개인특성(알코올 홍조, 니코틴 의존성 등), 건강관리(비만, 혈당, 혈압 등) 등으로 구성되어 있습니다.
                    ...
                    <div class="content-anchor">
                        ...
                        <ul class="anchor-option">
                            <li class="anchor-value" onclick="TitleMove('target5')"><a href="#">마이지놈스토리 더플러스 올인원 69 (세부항목 73종)</a></li>
                            <li class="anchor-value" onclick="TitleMove('target6')"><a href="#">마이지놈스토리 더플러스 스킨&케어 44 (세부항목 48종)</a></li>
                            <li class="anchor-value" onclick="TitleMove('target7')"><a href="#">마이지놈스토리 더플러스 피트니스 41(세부항목 43종)</a></li>
                            <li class="anchor-value" onclick="TitleMove('target8')"><a href="#">마이지놈스토리 더플러스 12 (세부항목 13종)</a></li>
                        </ul>
                    </div>
                    <!--content-anchor e-->
                    <div class="list-gallery">
                        <div class="list">
                            <p class="title font-h5" id="target5">마이지놈스토리 더플러스 올인원 69 (세부항목 73종)</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                                ...
                                <div class="cont">
                                    <p class="desc font-body caption_bottom">헬스&#38;뷰티 관리뿐 아니라 평소 궁금했던 개인의 특성 분석을 통해 ‘나’를 알아갈 수 있도록 돕습니다.  국내 최다 항목을 분석하는 올인원은 토탈 헬스케어가 가능한 프리미엄 상품입니다.  검사 항목 수는 지속적으로 업데이트될 예정이며,  ㈜마크로젠은 DTC 항목 확대가 가능한 첫 번째 인증기관입니다.</p>
                                    ...
                                    <div class="btn-wrap">
                                        <div class="btn-wrapper"><a href="mailto:mygenomestory@macrogen.com"
                                            ...
                                            <a href="https://smartstore.naver.com/mygenomestory/products/5372235474"
                                               target="_blank" class="btn btn-sm btn-primary"><span>구매하기</span></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="target6">마이지놈스토리 더플러스 스킨&#38;케어 44 (세부항목 48종)</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                                ...
                                <div class="cont">
                                    <p class="desc font-body">헬스&#38;뷰티 관리뿐 아니라 평소 궁금했던 개인의 특성 분석을 통해 ‘나’를 알아갈 수 있도록 돕습니다.  국내 최다 항목을 분석하는 올인원은 토탈 헬스케어가 가능한 프리미엄 상품입니다.  검사 항목 수는 지속적으로 업데이트될 예정이며,  ㈜마크로젠은 DTC 항목 확대가 가능한 첫 번째 인증기관입니다.</p>
                                    <p class="caption">※ 미성년자(만 19세 미만)는 검사 서비스가 불가능합니다.</p>
                                    <div class="list-area">
                                        <ul class="list-circle-dot">
                                            <li><p>피부/모발: 색소침착, 피부노화, 남성형 탈모 등 13개 항목</p></li>
                        ...
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="target7">마이지놈스토리 더플러스 피트니스 41(세부항목 43종)</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                                ...
                                <div class="cont">
                                    <p class="desc font-body">나에게 맞는 영양소와 운동 습관 설계에 필요한 항목을 분석할 수 있어, 건강 관리를 효과적으로 계획할 수 있도록 돕습니다. 검사 항목 수는 지속적으로 업데이트될 예정이며,  ㈜마크로젠은 DTC 항목 확대가 가능한 첫 번째 인증기관입니다.</p>
                                    <p class="caption">※ 미성년자(만 19세 미만)는 검사 서비스가 불가능합니다.</p>
                                    <div class="list-area">
                                        <ul class="list-circle-dot">
                        ...
                        <hr class="divider">
                        <div class="list">
                            <p class="title font-h5" id="target8">마이지놈스토리 더플러스 12 (세부항목 13종)</p>
                            <div class="content">
                                <!--10.05 이미지 경로 변경-->
                                <div class="img">
                                ...
                                <div class="cont">
                                    ...
                                    <div class="list-area">
                                        <ul class="list-circle-dot">
                                            ...
                                            <li><p>헤어: 남성형탈모, 원형탈모 등 3개 항목</p></li>
                                        </ul>
                                    </div>
                                    <div class="btn-wrap">
                                        <div class="btn-wrapper"><a href="mailto:mygenomestory@macrogen.com"
