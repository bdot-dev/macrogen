	                                    ...
	                                    <div class="cont">
	                                        ...
	                                        <div class="list-area">
	                                            <ul class="list-circle-dot">
	                                                <li><p>영양소 : 비타민 C 농도, 비타민 D 농도, 코엔자임Q10, 마그네슘 농도 등 23개 항목</p></li>
	                                                <li><p>운동 : 근력 운동 적합성, 지구력 운동 적합성, 운동 후 회복능력 등 총 10개 항목</p></li>
	                                                <li><p>피부/모발: 색소침착, 피부노화, 남성형 탈모 등 14개 항목</p></li>
	                                                <li><p>식습관: 식욕, 포만감, 쓴맛 민감도 등 총 12개 항목</p></li>
	                                                <li><p>개인특성: 알코올 홍조, 니코틴 의존성, 카페인 대사 등 21개 항목</p></li>
