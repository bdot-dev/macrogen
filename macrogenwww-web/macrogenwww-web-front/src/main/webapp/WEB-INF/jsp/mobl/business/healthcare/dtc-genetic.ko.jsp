                    ...
                    <div class="gentok__kv">
                        <div class="gentok__content">
                            <div class="gentok__text">
                                ...
                                <p class="gentok__description">유전자 분석을 통해 타고난 나의 특성을 알고, 몸속 미생물 분석으로 현재 건강 상태를 모니터링하면서 건강한 삶을 만들어가요</p>
                                <div class="gentok__btnwrap">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="jhttps://play.google.com/store/apps/details?id=app.macrogen.gentok&hl=ko" target="_blank" class="btn btn-default btn-default--regular btn-default--white">
                            ...
                            <ul class="examine__list swiper-wrapper">
                                    ...
                                    <div class="examine__inner">
                                        ...
                                        <div class="examine__right">
                                            <div class="examine__image">
                                                <img src="/resources/images/mo/func_image01.png" alt="129종의 다양한 검사항목" />
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="swiper-slide">
                                    <div class="examine__inner">
                                        ...
                                        <div class="examine__right">
                                            <div class="examine__image">
                                                <img src="/resources/images/mo/func_image02.png" alt="보건복지부 인증기관" />
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="swiper-slide">
                                    <div class="examine__inner">
                                        ...
                                        <div class="examine__right">
                                            <div class="examine__image">
                                                <img src="/resources/images/mo/func_image03.png" alt="AI 챗봇 유전상담 서비스" />
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="swiper-slide">
                                    <div class="examine__inner">
                                        ...
                                        <div class="examine__right">
                                            <div class="examine__image">
                                                <img src="/resources/images/mo/func_image04.png" alt="검사 항목별 관리 솔루션 제공" />
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                        ...
                                        <div class="examine__content">
                                            ...
                                            <div class="examine__desc">
                                                <p>
                                                    ...
                                                    그동안 알지 못했던 내 몸의 유전적 특성 <br />알아봐요
                                                </p>
                                            </div>
                                            ...
                                            <div class="examine__hidewrap">
                                                ...
                                                <div class="examine__hidebottom">
                                                    <ul class="examine__hidelist">
                                                        <li>
                                                            <div class="examine__itemname">영양소</div>
                                                            <div class="examine__itemdesc">비타민 C 농도, 비타민 D 농도, 코엔자임Q10, 마그네슘 농도 등 35개 항목</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">운동</div>
                                                            <div class="examine__itemdesc">근력 운동 적합성, 지구력 운동 적합성, 운동 후 회복능력 등 총 10개 항목</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">피부/모발</div>
                                                            <div class="examine__itemdesc">색소침착, 피부노화, 남성형 탈모 등 <br>18개 항목</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">식습관</div>
                                                            <div class="examine__itemdesc">식욕, 포만감, 쓴맛 민감도 등 총 21개 항목</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">개인특성</div>
                                                            <div class="examine__itemdesc">알코올 홍조, 니코틴 의존성, 카페인 대사 등 23개 항목</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">건강관리</div>
                                                            <div class="examine__itemdesc">비만, 요요 가능성, 복부비만, 중성지방농도 등 22개 항목</div>
                                                        </li>
                                                    </ul>
                                ...
                                <li>
                                    ...
                                    <div class="examine__toggle">
                                        <div class="examine__content">
                                            ...
                                            <div class="examine__desc">
                                                <p>
                                                    지속적으로 변화하는 몸 속 미생물을<br />
                                                    분석하여 현재 건강 상태를 체크해봐요
                                                </p>
                                            </div>
                                            <button type="button" class="examine__plus">더보기</button>
                                        </div>
                                        <div class="examine__hidecont">
                                            <div class="examine__hidewrap">
                                                ...
                                                <div class="examine__hidebottom">
                                                    <ul class="examine__hidelist">
                                                        <li>
                                                            <div class="examine__itemname">장 건강 및 라이프 지수 종합 분석</div>
                                                            <div class="examine__itemdesc">
                                                                <p class="examine__piece">
                                                                    <span class="examine__one">- 장 : </span>
                                                                    <span>변비, 방귀, 복부 팽만감, 설사</span>
                                                                </p>
                                                                <p class="examine__piece">
                                                                    <span>- 웰니스 :</span>
                                                                    <span>행복, 면역, 비만, 수면, 노화</span>
                                                                </p>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">영양소 대사 점수</div>
                                                            <div class="examine__itemdesc">- 비타민B군, 단백질&BCAA 등 14종</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">식약처 고시 <br>프로바이오틱스 19종 검출 여부</div>
                                                        </li>
                                                    </ul>
                                                    <div class="examine__hidebutton">
                                        ...
                                        <div class="examine__hidecont">
                                            <div class="examine__hidewrap">
                                                <div class="examine__hidebottom">
                                                    <ul class="examine__hidelist">
                                                        <li>
                                                            <div class="examine__itemname">질병확인서</div>
                                                            <div class="examine__itemdesc">유전질환의 가족력이 있거나 증상이 의심되는 경우 검사를 통해 조기진단 및 예방, 치료, 건강관리에 도움을 줄 수 있습니다.</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">DNA인증서</div>
                                                            <div class="examine__itemdesc">2개 시료의 유전자 좌위를 비교 분석하여 동일한 개체의 DNA인지 식별하는 검사입니다.</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">혈연확인서</div>
                                                            <div class="examine__itemdesc">반려동물 DNA의 고유한 유전자형을 비교 분석하여 부/모/자 간의 혈연관계를 입증하는 검사입니다.</div>
                                                        </li>
                                                        <li>
                                                            <div class="examine__itemname">성별확인서</div>
                                                            <div class="examine__itemdesc">암수의 성염색체 차이를 DNA분석을 통해 확인함으로써 조류의 성 감별이 가능합니다.</div>
                                                        </li>
                                                    </ul>
                                                    <div class="examine__hidebutton">
