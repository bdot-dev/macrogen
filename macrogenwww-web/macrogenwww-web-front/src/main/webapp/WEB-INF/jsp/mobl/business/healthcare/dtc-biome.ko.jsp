	            ...
	            <div class="info-box-wrap tab-content">
	                ...
	                <div class="info-box show">
	                    ...
	                    <p class="subject font-body-h">
							더바이옴은 마크로젠에서 제공하는 휴먼 마이크로바이옴 분석 서비스로, 장내 미생물 검사(더바이옴 GUT), 질내 미생물 검사(더바이옴 제인) 등 다양한 미생물 분석 서비스와 맞춤 솔루션을 제공합니다. 제 2의 유전체라 불리는 마이크로바이옴은 생활환경, 식습관에 따라 지속적으로 변화하기 때문에 장 건강, 질 건강은 물론 질병 발생 가능성에 대한 주기적인 모니터링이 가능합니다. 또한 젠톡을 통해 직접 검사 신청을 할 경우 병원을 가지 않고도 집에서 샘플채취, 분석의뢰, 결과확인 등 모든 과정을 진행할 수 있어 비대면 건강관리에 더욱 용이합니다.
							<br><br><span>** 추후 구강 미생물 검사 추가 예정</span>
	                    </p>
	                    <hr class="divider">
	                    <!--content-anchor s-->
	                    ...
	                    <div class="list-gallery">
	                        <div class="section-anchor">
	                            <div class="list">
	                                <p class="sub-title font-h5" id="target1">더바이옴 GUT</p>
	                                <div class="content">
	                                    <!--10.05 이미지 경로 변경-->
	                                    <div class="img">
