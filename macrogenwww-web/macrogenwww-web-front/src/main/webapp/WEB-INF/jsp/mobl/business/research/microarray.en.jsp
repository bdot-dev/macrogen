    ...
    <div class="container">
        <div class="section_business">
            ...
            <div class="subject-box">
                ...
                <p class="subject font-body-h img_bottom">This is a service that interprets useful genomic information using microarrays produced for various types of research.</p>
                <div class="img">
            ...
            <div class="info-box-wrap tab-content">
                ...
                <div class="info-box show">
                    ...
                    <p class="subject font-body-h-b">This is a technique for analyzing genomes with characteristics for which the expression level varies, depending on the biological environment.</p>
                    <!--10.05 이미지 경로 변경-->
                    <div class="img">
                ...
                <div class="info-box">
                    ...
                    <p class="subject font-body-h-b">This is a technique to analyze DNA sequence variants or structural changes.</p>
                    <!--10.05 이미지 경로 변경-->
                    <div class="img">
                ...
                <div class="info-box">
                    ...
                    <p class="subject font-body-h-b">This method quantifies and analyzes the level of methylation of numerous DNA sites at the same time.</p>
                    <!--10.05 이미지 경로 변경-->
                    <div class="img">
