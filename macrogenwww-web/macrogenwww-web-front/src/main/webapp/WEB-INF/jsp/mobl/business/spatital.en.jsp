...
<body>
	<div class="wrap">	
	    <div class="top-bg">
			...
			<div class="frame">
	            <div class="font-h4">Spatial<br>Transcriptome Analysis</div>
	        </div>
	    </div>
		<script>
			$(function(){
	    ...
	    <div class="container">
	        ...
	        <div class="section_business spatital">
	            ...
	            <div class="subject-box type02">
	                <p class="title font-h4">This is the research analysis technique that can simultaneously check spatial information and transcriptome information in tissues.</p>
					...
					<p class="desc font-body">As a CSP (Certified Service Provider) for spatial transcriptomics analysis by 10x Genomics, Macrogen is recognized for quick service delivery and a superior level of performance based on its NGS (Next Generation Sequencing) performance, and is ranked first in Korea and fifth in the world. We are also leading the market with diversified spatial transcriptomics analysis services by rapidly introducing new techniques.</p>
	            </div>
	            <!--//상단 공통 e -->
	            ...
	            <div class="info-box-wrap tab-content">
	                ...
	                <div class="info-box">
	                    ...
	                    <div class="border-gray-box">
	                        <div class="img">
	                            <img src="/publishing/mobile-en/dist/img/business/img_single_cell09.png" alt="">
