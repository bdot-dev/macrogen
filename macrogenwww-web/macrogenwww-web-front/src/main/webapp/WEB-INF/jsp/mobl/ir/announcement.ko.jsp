    ...
    <div class="container pt-0 vuelayer" v-cloak>
        ...
        <div class="section_IR board">
            <div class="text-list">
                ...
                <div class="btn-wrapper" v-if="resultList.length > 0 && paginationInfo.currentPageNo < paginationInfo.lastPageNo">
			...
			methods : {
				fetchData : function() {
					...
					$.ajax({
						...
						url : '/${langId}/ir/announcement/data',
				...
				onViewLink : function (nttSn){
					$form.attr({
						action: '/${langId}/ir/announcement/' + nttSn,
						method : 'get'
					}).submit();
				},
				onMore: function() {
