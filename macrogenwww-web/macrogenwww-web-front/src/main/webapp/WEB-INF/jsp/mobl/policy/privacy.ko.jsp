...
<body>
    ...
    <div class="inner">
        ...
        <div class="frame">
            <div class="font-h1">마크로젠 개인정보 처리방침</div>
        </div>
    </div>
            ...
            <div class="select-box">
                ...
                <ul class="select-option _select-option">
                    <c:forEach  var="result" items="${resultList }" varStatus="status" >
                    	...
                    	<li class="option-value"><a href="/${rc.locale.language }/policy/privacy/${result.policySn}"><fmt:formatDate value="${result.applcDe }" pattern="yyyy.MM.dd" /> - ${ endDe }</a></li>
					</c:forEach>
                </ul>
            </div>
            <script>
