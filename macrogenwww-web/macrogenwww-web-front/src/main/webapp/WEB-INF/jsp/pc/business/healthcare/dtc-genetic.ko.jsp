			...
			<div class="frame frameB">
	            <nav aria-label="breadcrumb">
	                <ol class="breadcrumb breadcrumb-white">
	                    ...
	                    <li class="breadcrumb-item">DTC 유전자검사</li>
	                </ol>
	            </nav>
	            <div class="hero-title">DTC 유전자검사</div>
		...
		<div class="container">
	        ...
	        <div class="section_business">
	            <div class="subject-box type01">
	                <p class="font-h4 title">DTC 유전자검사</p>
	                <p class="subject">
	                	의료기관을 방문하지 않고, 소비자가 직접 개인의 특성이나 건강과 관련된 웰니스 항목을 검사할 수 있는 유전자검사 서비스를 제공합니다. 검사 항목은 영양소, 운동, 피부·모발,<br/>
	                	식습관, 개인특성(알코올 홍조, 니코틴 의존성 등), 건강관리(비만, 혈당, 혈압 등) 등으로 구성되어 있습니다.<br/>
	                                ...
	                                <div class="cont">
	                                    ...
	                                    <div class="list-area">
	                                        <ul class="list-circle-dot">
	                                            <li>영양소 : 비타민 C 농도, 비타민 D 농도, 코엔자임Q10, 마그네슘 농도 등 23개 항목</li>
	                                            <li>운동 : 근력 운동 적합성, 지구력 운동 적합성, 운동 후 회복능력 등 총 10개 항목</li>
	                                            <li>피부/모발: 색소침착, 피부노화, 남성형 탈모 등 14개 항목</li>
	                                            <li>식습관: 식욕, 포만감, 쓴맛 민감도 등 총 12개 항목</li>
	                                            <li>개인특성: 알코올 홍조, 니코틴 의존성, 카페인 대사 등 21개 항목</li>
