...
<body class="en">
    ...
    <div class="full-bg macrogen" style="background-image: url(/publishing/pc-en/dist/img/@temp/macrogen/macrogen_bg_1.png);">
        ...
        <div class="frame">
                ...
                <div class="slogan">Opening a new door for the<br/>development of genomic analysis</div>
	                    ...
	                    <div class="swiper-wrapper _swiperTab">
	                    	<c:forEach var="result" items="${ resultList }" varStatus="status">
		                        <div class="swiper-slide ${ status.index eq 0 ? 'active' : '' }"><a
		                        	href="javascript:;" onclick="fnMove('group-${result.cmpnyhistGroupSn }')">${result.beginYear } &#45; ${result.endYear eq 'present' ? 'Present' : result.endYear }</a></div>
		                    </c:forEach>
	                    </div>
	                </div>
	            </div>
