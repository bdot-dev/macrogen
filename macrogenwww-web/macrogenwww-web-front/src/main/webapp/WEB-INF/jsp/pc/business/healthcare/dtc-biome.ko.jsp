	...
	<div class="container">
		...
		<div class="section_business biome">
			<div class="subject-box type01">
				...
				<p class="subject">
					더바이옴은 마크로젠에서 제공하는 휴먼 마이크로바이옴 분석 서비스로, 장내 미생물 검사(더바이옴 골드) 외 다양한 미생물 분석 서비스를 제공합니다.<br>
					제 2의 유전체라 불리는 마이크로바이옴은 생활환경, 식습관에 따라 지속적으로 변화하기 때문에<br>
					장 건강, 질 건강은 물론 질병 발생 가능성에 대한 주기적인 모니터링이 가능합니다. 또한 젠톡을 통해 직접 검사 신청을 할 경우 병원을 가지 않고도<br>
					집에서 샘플채취, 분석의뢰, 결과확인 등 모든 과정을 진행할 수 있어 비대면 건강관리에 더욱 용이합니다.
				</p>
			</div>
			...
			<div class="info-box-wrap tab-content">
				<div class="info-box show">
					...
					<div class="list-gallery">
						<div class="list">
							<p class="title font-h5">더바이옴 골드</p>
							<div class="content">
								<div class="picture">
