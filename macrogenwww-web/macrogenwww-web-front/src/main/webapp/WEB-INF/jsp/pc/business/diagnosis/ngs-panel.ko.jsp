	...
	<div class="container">
		...
		<div class="section_business">
			...
			<div class="tab-box" id="_tab-box">
                ...
                <p class="info">환자 개개인의 맞춤 치료가 가능한 정밀 의학 구현을 위해, 많은 병원과 기관에서 NGS(차세대염기서열분석)을 기반으로 한 유전자 패널 검사실 구축을 희망하고 있습니다. <br>하지만 NGS 기반 유전자 패널 검사실은 축적된 노하우로 개발된 임상 진단 패널과 숙련된 전문 인력, 인증 받은 시퀀싱 플랫폼 장비 구축이 필수이며, 많은 시간과 비용이 소비됩니다. <br>마크로젠은 NGS 패널, 수행 인력, 결과 분석, Lab 장비 등 모든 서비스를 맞춤 지원하고있습니다.</p>
