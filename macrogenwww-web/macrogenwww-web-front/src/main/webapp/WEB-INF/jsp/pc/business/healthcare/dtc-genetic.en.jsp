	...
	<div class="wrap">
		<div class="full-bg business_bg bg-personal02">
			...
			<div class="frame frameB">
	            ...
	            <h2 class="hero-title">Healthcare Platform</h2>
	                    ...
	                    <div class="list-gallery">
	                        <div class="list">
								...
								<div class="img" style="margin-top: 45px;">
									<img src="/publishing/pc-en/dist/img/business/img_healthbeauth_img03.jpg" alt="AI Chatbot">
								</div>
	                        </div>
		                    <div class="list">
	                        ...
	                        <div class="list">
	                            ...
	                            <div class="content">
	                                ...
	                                <div class="cont">
	                                    <p class="desc">This is the only test solution that is available to persons under the age of 19, and consists of only the key services essential for easy and efficient health and beauty management.</p>
	                                    <div class="list-area">
	                                        <ul class="list-circle-dot">
