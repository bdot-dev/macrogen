                    ...
                    <div class="item">
                     ...
                     <!-- <div class="item">	2023.02.03 회사소개서 주석
                        ...
                        <div class="desc">
                            ...
                            <div class="download-area">
                            	<a class="btn-download" href="/downfile/e_brochure_ko_230110_compressed.pdf" target="_blank" style="padding-right:44px;"><span>국문 PDF</span><i class="icon icon-download"></i></a>
