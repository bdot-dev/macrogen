...
<link type="text/css" rel="stylesheet" href="/publishing/pc-ko/dist/css/macrogen_page_pc_ko.css?${cssVar}"/>
...
<script src="/publishing/pc-ko/dist/js/bundle.js?${cssVar}"></script>
...
<script src="/publishing/pc-ko/dist/js/common.js?${cssVar}"></script>
