...
<c:import url="/inc/header-inner-gnb" />
    ...
    <div class="container container-fluid">
        <div class="section_syncgenes">
            <div class="info-box">
                <div class="font-h3">데이터 통합 &#183; 분석을 통해<br>정밀의료를 완성합니다 </div>
        ...
        <div class="section_info_list syncgenes-area">
            <div class="box clearfix">
                <div class="font-h7">연구<span>유전체&#40;genetic&#41; 데이터&#44; 임상&#40;clinical&#41; 데이터&#44;<br>건강관련 생활 &#40;health-related lifestyle&#41; 데이터의<br>통합&#40;문제를 해결하기&#41;을 위한 연구</span></div>
                <div class="font-body">
            ...
            <div class="box clearfix">
                <div class="font-h7">분석<span>통합된 데이터를 이용한<br>다양한 예측 및 인공지능 분석 연구</span></div>
                <div class="font-body">
                    <img src="/publishing/pc-ko/dist/img/RD/img-syncgenes_analysis.png" alt="인간 게놈 염기서열">
                </div>
            </div>
            <div class="box clearfix">
                <div class="font-h7">정밀의료<span>분석 연구결과를 임상 및 건강관리와<br>정밀의료 신기술 개발에 적용하기 위한 연구</span></div>
                <div class="font-body">
