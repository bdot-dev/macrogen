    ...
    <div class="container">
        <div class="section_business">
            ...
            <div class="list-area-group">
                ...
                <div class="btn-area">
                    <a href="#" class="btn btn-white"><span>Service Inquiry</span></a>
                    <a href="#" class="btn btn-white"><span>Quotation</span></a>
                    <a href="#" class="btn btn-primary"><i class="icon icon-basket-white"></i><span>Order</span></a>
                </div>
            </div>
        </div>
    </div>
