...
<body>
    ...
    <div class="full-bg macrogen" style="background-image: url(/publishing/pc-en/dist/img/macrogen/bg-macrogen-human-resource.png);">
            ...
            <div class="section-welfare">
                <div class="inner" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div class="click-area">
                        ...
                        <div class="btn-wrap"><a href="/${rc.locale.language }/company/recruit" class="btn btn-text"><span>채용안내</span><i class="icon icon-arrow-right-long"></i></a></div>
                    </div>
                </div>
                <div class="item item-1">
                    <div class="inner" data-aos="fade-up" data-aos-duration="2000">
