...
<body class="en">
    ...
    <div class="full-bg macrogen" style="background-image: url(/publishing/pc-en/dist/img/macrogen/bg-vision.png);">
...
<header class="header" id="header">
	<c:import url="/inc/header-inner-gnb" />
        ...
        <div class="frame">
                ...
                <div class="slogan">Global leading precision<br/>medicine company</div>
                <div class="slogan-sub">Predicts and diagnoses diseases and provides personalized solutions.</div>
