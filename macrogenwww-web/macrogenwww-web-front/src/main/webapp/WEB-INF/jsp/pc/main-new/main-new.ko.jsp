               	...
               	<c:forEach var="result" items="${ mainBannerList }" varStatus="status">     
	               	<c:if test="${result.expsrYn == 'Y'}">
		                <div class="swiper-slide visual_00" data-swiper-autoplay="8000">
		                    ...
		                    <div class="text-box">
		                        <p class="text-gradient">${result.title}</p>
    ...
    <div class="container container-fluid">
        <div class="main-page company-define">
            <div class="section-define">
                ...
                <div class="info-box">
	                <div class="title">
	                    <div class="title" data-aos="fade-up" data-aos-duration="500">PEOPLE</div>
	                </div>
	                <!-- 피플 관리 영역 start -->
	                <c:forEach var="result" items="${ mainPeopleList }" varStatus="status">
		                <c:if test="${ result.viewYn == 'Y' }">
		                	<table border="1">
		                		<tr>
		                			<th>이름 : </th>
		                			<td>${ result.peopleNm }</td>
		                		</tr>
		                		<tr>
		                			<th>직함 : </th>
		                			<td>${ result.peopleDept }</td>
		                		</tr>
		              			<tr>
		                			<th>PC 내용 : </th>
		                			<td>${ result.cnPc }</td>
		                		...
		                		<tr>
		                			<th>PC 이미지 : </th>
		                			<td><img src="${publicUrl}${result.imageFlpthPc}"></td>
		                		</tr>
		                		<tr>
		                			<th>MO 이미지 : </th>
		                			<td><img src="${publicUrl}${result.imageFlpthPc}"></td>
