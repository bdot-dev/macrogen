                     ...
                     <div class="map-info">
                         <div class="inner">
                          <div class="address-wrap">
                               <i class="pin"></i>
                               <span class="tit">Macrogen HQ</span>
                               <span class="address">238, Teheran-ro, Gangnam-gu, Seoul, Republic of Korea</span>
                           </div>
                           <div class="pin-btn-wrap"><a class="btn btn-sm btn-white" href="https://goo.gl/maps/sd5Puv13CMhr2T5LA"><i class="google-pin"></i><span>Find Directions on Google Maps</span></a></div>
                         </div>
                      </div>
                </div>
            </div>
