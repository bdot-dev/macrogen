	...
	<div class="container">
		...
		<div class="section_business">
            ...
            <div class="tab-box" id="_tab-box">
                ...
                <p class="info">마크로젠의 임상지놈사업본부는 임상시험검체분석 전문 서비스를 제공합니다. <br>2019년 유전체분석기관 최초 임상시험검체분석기관 지정을 식약처로부터 받았으며 국내 GCLP 기준 외에 해외 CAP, CLIA, CSP등의 다양한 인증 기반 차별화된 서비스를 선보이고 있습니다.이는 국내임상시험 및 해외 임상시험의 요구조건을 충족 시키기 위한 마크로젠만의 노력입니다. 또한, 마크로젠은 국내 및 해외 임상시험 요구조건을 충족시키기 위해 노력하고 있습니다. 분석 전문 CRO로서 바이오마커 발굴 및 검체분석에 있어 차별화된 분석 서비스 영역을 개척합니다. <br>멀티 오믹스 기반의 다양한 분석방법을 갖추고 최신 분석 트렌드를 제시하며, 임상시험의 성공률을 높이기 위한 전략적인 방법으로 서비스를 제공해드립니다.</p>
