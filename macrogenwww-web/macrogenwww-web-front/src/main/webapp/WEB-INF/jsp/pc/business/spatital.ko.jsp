	        ...
	        <div class="section_business spatital">
	            ...
	            <div class="info-box-wrap tab-content">
	                ...
	                <div class="info-box show">
	                    ...
	                    <p class="desc">마크로젠은 공간 전사체 분석(spatial gene expression) 서비스의 CSP(Certified service provider) 인증을 받았으며, 국내 1위이자 세계 5위 수준의 차세대염기서열분석(Next generation sequencing,NGS) 수행능력을 기반으로 높은 수준의 유전자 분석 데이터를 빠른 시간 내에 제공한다는 장점이 있습니다. 또한 새로 등장하는 공간 유전체 분석의 신기술을 빠르게 도입함으로써 공간 유전체 분석 서비스를 다양화하며 시장을 선도하고 있습니다.</p>
	                    <hr class="divider" />
	                    <p class="font-h4 main-title mb120">PLATFORM</p>
