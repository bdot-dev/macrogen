		...
		<div class="container">
	        <div class="section_business">
	            ...
	            <div class="subject-box">
	                ...
	                <!--10.05 이미지 경로 변경-->
	                <div class="img">
	                    <img src="/publishing/pc-ko/dist/img/business/img-ces-intro.png" alt="CESIntro">
	                </div>
	                ...
	                <div class="slide-tab-wrap">
	                    <div class="swiper-container tab-slide-box _swiperTab swiper-container-initialized swiper-container-horizontal">
	                        <div class="swiper-wrapper _swiperTab swiper-container-initialized swiper-container-horizontal">
	                            <div class="swiper-slide active" id="standard" onclick="setTabContent(0)"><a href="#">Standard Sequencing</a></div>
	                            <div class="swiper-slide" id="identification" onclick="setTabContent(1)"><a href="#">Identification</a></div>
	                            <div class="swiper-slide" id="fragment" onclick="setTabContent(2)"><a href="#">Fragment</a></div>
	                            <div class="swiper-slide" id="customized" onclick="setTabContent(3)"><a href="#">Customized Sequencing</a></div>
	                            <div class="swiper-slide" id="human" onclick="setTabContent(4)"><a href="#">Human ID</a></div>
	            ...
	            <div class="info-box-wrap tab-content">
	                ...
	                <div class="info-box show">
	                    ...
	                    <!--10.05 이미지 경로 변경-->
	                    <div class="img">
	                        <img src="/publishing/pc-ko/dist/img/business/img-ces-standard.png" alt="Standard Sequencing">
	                    </div>
	                    <div class="list-area">
	                    ...
	                    <div class="border-gray-box">
	                        <img src="/publishing/pc-ko/dist/img/business/img_sequencingchart.png" alt="Difficult Template Sequencing">
	                    </div>
	                    <div class="btn-area">
	                ...
	                <div class="info-box">
	                    ...
	                    <!--10.05 이미지 경로 변경-->
	                    <div class="img">
	                        <img src="/publishing/pc-ko/dist/img/business/img-ces-identification.png" alt="Identification">
	                    </div>
	                    <hr class="divider">
	                ...
	                <div class="info-box">
	                    ...
	                    <div class="img">
	                        <!--10.05 이미지 경로 변경-->
	                        <img src="/publishing/pc-ko/dist/img/business/img-ces-fragment.png" alt="Fragment">
	                    </div>
	                    <hr class="divider">
	                ...
	                <div class="info-box">
	                    ...
	                    <!--10.05 이미지 경로 변경-->
	                    <div class="img">
	                        <img src="/publishing/pc-ko/dist/img/business/img-ces-customized.png" alt="Customized Sequencing">
	                    </div>
	                    <hr class="divider">
	                    ...
	                    <!--10.05 이미지 경로 변경-->
	                    <div class="img">
	                        <img src="/publishing/pc-ko/dist/img/business/img_mslt.png" alt="MLST 분석">
	                    </div>
	                    <hr class="divider">
	                    ...
	                    <div class="list-gallery">
	                        <div class="list">
	                            ...
	                            <div class="content">
	                                <!--10.05 이미지 경로 변경-->
	                                <div class="picture">
	                                    <img src="/publishing/pc-ko/dist/img/business/img-ces-test1.png" alt="친자확인검사">
	                                </div>
	                        ...
	                        <div class="list">
	                            ...
	                            <div class="content">
	                                <!--10.05 이미지 경로 변경-->
	                                <div class="picture">
	                                    <img src="/publishing/pc-ko/dist/img/business/img-ces-test2.png" alt="부계확인검사">
	                                </div>
	                        ...
	                        <div class="list">
	                            ...
	                            <div class="content">
	                                <!--10.05 이미지 경로 변경-->
	                                <div class="picture">
	                                    <img src="/publishing/pc-ko/dist/img/business/img-ces-test3.png" alt="모계확인검사">
	                                </div>
	                        ...
	                        <div class="list">
	                            ...
	                            <div class="content">
	                                <!--10.05 이미지 경로 변경-->
	                                <div class="picture">
	                                    <img src="/publishing/pc-ko/dist/img/business/img-ces-test4.png" alt="개인식별검사">
	                                </div>
