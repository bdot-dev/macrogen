...
// modal show
var modalIMG = new bootstrap.Modal(document.getElementById('modalImageViewer'));
...
$('.btnZoom').each(function(){
    ...
    $(this).click(function(){
        $(".modal-image-viewer .zoom_img img").attr("src","/publishing/mobile-ko/dist/img/business/"+zoomIMG+"_zoom.png");
        modalIMG.show();
        showToastPopup();
    })
});
