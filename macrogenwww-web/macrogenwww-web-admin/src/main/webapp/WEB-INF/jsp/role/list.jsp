			...
			<fieldset>
				<div class="list_wrap">
					...
					<form:select path="searchCondition" style="width:100px;" class="mr5">
						<form:option value="role_id">권한ID</form:option>
					</form:select>
			...
			<table class="table_col">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="javascript:linkView('${result.roleId }')">${result.roleId }</a></td>
						<td>${result.roleNm}</td>
