			...
			<div class="board_wrap mb20">
				...
				<tbody>
					<tr>
						...
						<td class="tal" colspan="3">
							<label v-for="(result, index) in expsrYnList">
								...
								name="expsrYns" :id="'expsrYn' + index" :value="result.code">
								{{ result.codeNm }}
							</label>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3" class="tal">
							<div class="lbMaxlenPrnt">
								<input type="text" id="linkUrl1" ref="linkUrl1" maxlength="50" placeholder="링크" v-model="resultVo.linkUrl1" class="w100p" />
							</div>
						</td>
					</tr>
				</tbody>
