...
<body>
	...
	<form:form commandName="listVo" id="listForm" name="listForm">
		...
		<form:hidden path="searchCntntsCtgryCode"/>
	...
	<form id="editForm" name="editForm" enctype="multipart/form-data">
		<div class="page_wrap vuelayer">
						...
						<tr>
							...
							<td colspan="3" class="tal">
								<div class="lbMaxlenPrnt">
									<input type="text" v-model="resultVo.cntntsSj" ref="cntntsSj"
										maxlength="80" placeholder="제목" class="w100p txtMaxlen" />
								</div>
							</td>
						</tr>
			...
			<div class="board_wrap mb20" v-if="resultVo.cntntsSn">
				<table class="table_row mb20">
					<colgroup>
						<col width="15%">
						<col width="35%">
			...
			<div class="board_wrap mb20">
				<div class="btn_wrap tar">
					...
					<button v-if="resultVo.cntntsSn" type="button" name="button" class="btn" v-on:click="onDelete">삭제</button>
	...
	<script src="/js/app/SocialContentsForm.js"></script>
	<script>
		$(function (){
			var options = {
					cntntsSn : ${ empty cntntsSn ? 'null' : cntntsSn },
			}
			options.lang = '${langId}';
			options.Lang = '${lang}';
			cntntsForm.init(options);
		});
