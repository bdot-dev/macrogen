...
<body>
	...
	<script type="text/javascript" src="/js/app/LoginLogList.js" ></script>
	...
	$(function (){
		var listVo = {
			...
			searchCondition : '${ empty listVo.searchCondition ? "RESULT" : listVo.searchCondition }',
		}
		var options = {
			listVo: listVo,
		};
		loginLogList.init(options);
	});
