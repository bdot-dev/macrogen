...
<body>
	...
	<div class="page_wrap vuelayer" v-cloak>
		...
		<div class="board_wrap mb20">
			<table class="table_col">
				...
				<tbody v-if="resultList.length == 0">
					<tr >
						<td nowrap colspan="7" style="padding:80px 0px;text-align:center;">로그 기록이 없습니다.</td>
					</tr>
				</tbody>
			</table>
	...
	<script type="text/javascript" src="/js/app/InvstLogList.js" ></script>
