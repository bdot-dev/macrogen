...
<body>
	<!-- 검색조건 저장용 -->
	<form:form commandName="mngrurlVo" id="listForm" name="listForm">
					...
					<tr>
						...
						<td colspan="3" class="tal">
							<form:select path="menuSn">
								<form:options items="${mngrmenuList }" itemValue="menuSn" itemLabel="menuNmPath" />
							</form:select>
						</td>
					</tr>
	...
	function goList() {
		...
		$listForm.attr('action', '/mngrurl/list');
		$listForm.submit();
	}
	</script>
</body>
