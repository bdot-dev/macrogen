...
<body>
		...
		<div class="page_wrap vuelayer" v-cloak>
				...
				<table class="table_row mb20">
					...
					<tbody>
						...
						<tr>
							<th>생년월일 </th>
							<td colspan="3">
								<input type="text" v-model="resultVo.brthdy" maxlength="10" placeholder="생년월일 (예 : 1990-01-01)" class="w100p" />
							</td>
						</tr>
			...
			<div class="board_wrap mb20">
				<div class="btn_wrap tar">
					...
					<button v-if="resultVo.userSn" type="button" name="button" class="btn" v-on:click="onDelete">삭제</button>
                    <button v-if="resultVo.userSn" type="button" name="button" class="btn" v-on:click="onInitErrCnt">비밀번호 입력 오류 회수 초기화</button>
	...
	<script src="/js/app/MberForm.js"></script>
	<script>
	$(function() {
		var options = {
