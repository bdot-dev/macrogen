			...
			methods : {
				fetchData : function() {
					...
					$.ajax({ dataType : 'json', type : 'post',
						...
						url : '/' + options.lang + '/main-news/list/data',
				...
				onAdd : function() {
					$form.attr({
						action : '/' + options.lang + '/main-news/form',
						method : 'post'
					}).submit();
				},
				onViewLink : function(sn) {
					$form.attr({
						action : '/' + options.lang + '/main-news/form/' + sn,
						method : 'post'
					}).submit();
				},
				...
				onDeleteChecked: function() {
					...
					$.ajax({dataType : 'json', type : 'post',
						contentType : 'application/json',
						url : '/' + options.lang + '/main-news/deleteList',
