var MainSomlnkForm = (function($) {
			...
			methods : {
				fetchData : function() {
					...
					$.ajax({dataType : 'json', type : 'post',
						...
						url : '/' + options.lang + '/main-somlnk/form/data',
				...
				onDelete : function() {
					...
					$.ajax({dataType : 'json', type : 'post',
						contentType : 'application/json',
						url : '/' + options.lang + '/main-somlnk/delete',
						data : JSON.stringify(vm.resultVo),
					}).done(function(data) {
						goList();
					});
	...
	var goList = function() {
		...
		$listForm.attr('action', '/' + options.lang + '/main-somlnk/list');
		$listForm.submit();
	};
